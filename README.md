...
o	Services handle data access logic instead of controllers.
•	DTO pattern
o	API uses DTOs for requests and responses.
•	Dependency Injection
o	Services and DbContext are injected through constructors.
•	Middleware
o	A simple global exception middleware handles API errors and logs them.
...
Approximately:
40+ hours
Spread across several sessions including:
•	project setup
•	database modeling
•	API development
•	MVC pages
